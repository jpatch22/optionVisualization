...
import 'package:option_visualizer/screens/bs_op_page.dart';
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => BsOpPage())
              );
            }, 
            child: Text("Option Value Modelling with Black Scholes Equation"))
          ],
        ),
      ),
    );
