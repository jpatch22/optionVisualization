...
class Utils {
  ...
  static List<List<double>> parse2DArrayFromJson(String jsonString, String key) {
  ...
  static List<double> parse1DArrayFromJson(String jsonString, String key) {
    final jsonResponse = json.decode(jsonString);
    final assetPricesJson = jsonResponse[key] as List<dynamic>;
    return assetPricesJson.map((e) => e as double).toList();
  }
}
